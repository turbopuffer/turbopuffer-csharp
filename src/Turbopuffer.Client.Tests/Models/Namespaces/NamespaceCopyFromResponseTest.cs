...
public class NamespaceCopyFromResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NamespaceCopyFromResponse
        {
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NamespaceCopyFromResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        NamespaceCopyFromResponse copied = new(model);

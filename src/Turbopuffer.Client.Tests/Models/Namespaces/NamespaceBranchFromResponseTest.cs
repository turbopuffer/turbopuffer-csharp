...
public class NamespaceBranchFromResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NamespaceBranchFromResponse
        {
            Billing = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NamespaceBranchFromResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        NamespaceBranchFromResponse copied = new(model);

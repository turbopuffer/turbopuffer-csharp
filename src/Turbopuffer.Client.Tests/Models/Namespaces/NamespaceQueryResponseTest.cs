...
public class NamespaceQueryResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new NamespaceQueryResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<NamespaceQueryResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        NamespaceQueryResponse copied = new(model);

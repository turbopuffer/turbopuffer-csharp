...
namespace Turbopuffer.Client.Tests;
...
public class RetriesTest : TestBase
{
    ...
    public async Task ImmediateSuccess_Works()
    {
        ...
        TurbopufferClient client = new() { HttpClient = httpClient, MaxRetries = 2 };
    ...
    public async Task RetryAfterMsHeader_Works()
    {
        ...
        TurbopufferClient client = new() { HttpClient = httpClient, MaxRetries = 1 };

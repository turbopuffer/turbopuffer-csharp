...
public sealed record class NamespaceMetadata : JsonModel
{
    ...
    public required global::Turbopuffer.Models.Namespaces.Index Index
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<global::Turbopuffer.Models.Namespaces.Index>(
                "index"
            );
        }
...
public record class Index : ModelBase
{
    ...
    public static implicit operator global::Turbopuffer.Models.Namespaces.Index(
        IndexUpToDate value
    ) => new(value);
    ...
    public virtual bool Equals(global::Turbopuffer.Models.Namespaces.Index? other) =>
        other != null
...
sealed class IndexConverter : JsonConverter<global::Turbopuffer.Models.Namespaces.Index>
{
    public override global::Turbopuffer.Models.Namespaces.Index? Read(
    ...
    public override void Write(
        ...
        global::Turbopuffer.Models.Namespaces.Index value,
        JsonSerializerOptions options
    )
    {

...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<WriteResult, WriteResultFromRaw>))]
public sealed record class WriteResult : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WriteResult(WriteResult writeResult)
        : base(writeResult) { }
#pragma warning restore CS8618

    public WriteResult(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    WriteResult(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="WriteResultFromRaw.FromRawUnchecked"/>
    public static WriteResult FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class WriteResultFromRaw : IFromRawJson<WriteResult>
{
    /// <inheritdoc/>
    public WriteResult FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        WriteResult.FromRawUnchecked(rawData);
}

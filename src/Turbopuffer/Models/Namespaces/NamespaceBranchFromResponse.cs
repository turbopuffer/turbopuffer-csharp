...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<NamespaceBranchFromResponse, NamespaceBranchFromResponseFromRaw>)
)]
public sealed record class NamespaceBranchFromResponse : JsonModel
{
    /// <summary>
    ...
    public NamespaceBranchFromResponse()
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public NamespaceBranchFromResponse(NamespaceBranchFromResponse namespaceBranchFromResponse)
        : base(namespaceBranchFromResponse) { }
#pragma warning restore CS8618

    public NamespaceBranchFromResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NamespaceBranchFromResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="NamespaceBranchFromResponseFromRaw.FromRawUnchecked"/>
    public static NamespaceBranchFromResponse FromRawUnchecked(
...
class NamespaceBranchFromResponseFromRaw : IFromRawJson<NamespaceBranchFromResponse>
{
    /// <inheritdoc/>
    public NamespaceBranchFromResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => NamespaceBranchFromResponse.FromRawUnchecked(rawData);
}

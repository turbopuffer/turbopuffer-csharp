...
/// </summary>
[JsonConverter(typeof(AttributeSchemaConverter))]
public record class AttributeSchema : ModelBase
{
    ...
    public AttributeSchema(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public AttributeSchema(AttributeSchemaConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    /// </example>
    /// </summary>
    public bool TryPickType([NotNullWhen(true)] out string? value)
    {
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="AttributeSchemaConfig"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    ...
    ///     // `value` is of type `AttributeSchemaConfig`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickConfig([NotNullWhen(true)] out AttributeSchemaConfig? value)
    {
        value = this.Value as AttributeSchemaConfig;
        return value != null;
    }
...
sealed class AttributeSchemaConverter : JsonConverter<AttributeSchema>
{
    public override AttributeSchema? Read(

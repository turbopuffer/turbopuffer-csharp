...
/// </summary>
public record class NamespaceStartCopyFromParams : ParamsBase
{
    ...
    public NamespaceStartCopyFromParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public NamespaceStartCopyFromParams(NamespaceStartCopyFromParams namespaceStartCopyFromParams)
        : base(namespaceStartCopyFromParams)
    {
        this.Namespace = namespaceStartCopyFromParams.Namespace;

        this._rawBodyData = new(namespaceStartCopyFromParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static NamespaceStartCopyFromParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string namespace_
    ...
    public virtual bool Equals(NamespaceStartCopyFromParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        ...
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v2/namespaces/{0}/async", this.Namespace)
        )
        {
            Query = string.IsNullOrEmpty(queryString)
                ? "stainless_overload=startCopyFrom"
                : ("stainless_overload=startCopyFrom&" + queryString),
        }.Uri;
    }

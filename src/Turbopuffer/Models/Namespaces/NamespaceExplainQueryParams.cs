...
public record class NamespaceExplainQueryParams : ParamsBase
{
    ...
    /// how to compute it.
    /// </summary>
    public IReadOnlyDictionary<string, ComputeAttribute>? ComputeAttributes
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<FrozenDictionary<string, ComputeAttribute>>(
                "compute_attributes"
            );
        }
        init
        {
            ...
            this._rawBodyData.Set<FrozenDictionary<string, ComputeAttribute>?>(
                "compute_attributes",
                value == null ? null : FrozenDictionary.ToFrozenDictionary(value)
            );
        }
...
/// </summary>
[JsonConverter(typeof(ComputeAttributeConverter))]
public record class ComputeAttribute : ModelBase
{
    ...
    public ComputeAttribute(IReadOnlyList<JsonElement> value, JsonElement? element = null)
    {
    ...
    public ComputeAttribute(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new TurbopufferInvalidDataException(
                    "Data did not match any variant of ComputeAttribute"
                );
        }
    }
    ...
    public static implicit operator ComputeAttribute(List<JsonElement> value) =>
        new((IReadOnlyList<JsonElement>)value);

    public static implicit operator ComputeAttribute(List<List<JsonElement>> value) =>
    ...
    public virtual bool Equals(ComputeAttribute? other) =>
        other != null
...
sealed class ComputeAttributeConverter : JsonConverter<ComputeAttribute>
{
    public override ComputeAttribute? Read(

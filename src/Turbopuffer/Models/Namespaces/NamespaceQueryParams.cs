...
public record class NamespaceQueryParams : ParamsBase
{
    ...
    /// how to compute it.
    /// </summary>
    public IReadOnlyDictionary<string, NamespaceQueryParamsComputeAttribute>? ComputeAttributes
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<
                FrozenDictionary<string, NamespaceQueryParamsComputeAttribute>
            >("compute_attributes");
        }
        init
        {
            ...
            this._rawBodyData.Set<FrozenDictionary<string, NamespaceQueryParamsComputeAttribute>?>(
                "compute_attributes",
                value == null ? null : FrozenDictionary.ToFrozenDictionary(value)
            );
        }
...
/// </summary>
[JsonConverter(typeof(NamespaceQueryParamsComputeAttributeConverter))]
public record class NamespaceQueryParamsComputeAttribute : ModelBase
{
    ...
    public NamespaceQueryParamsComputeAttribute(
    ...
    public NamespaceQueryParamsComputeAttribute(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new TurbopufferInvalidDataException(
                    "Data did not match any variant of NamespaceQueryParamsComputeAttribute"
                );
        }
    }
    ...
    public static implicit operator NamespaceQueryParamsComputeAttribute(List<JsonElement> value) =>
        new((IReadOnlyList<JsonElement>)value);

    public static implicit operator NamespaceQueryParamsComputeAttribute(
        List<List<JsonElement>> value
    ...
    public virtual bool Equals(NamespaceQueryParamsComputeAttribute? other) =>
        other != null
...
sealed class NamespaceQueryParamsComputeAttributeConverter
    : JsonConverter<NamespaceQueryParamsComputeAttribute>
{
    public override NamespaceQueryParamsComputeAttribute? Read(
    ...
    public override void Write(
        ...
        NamespaceQueryParamsComputeAttribute value,
        JsonSerializerOptions options
    )
    {

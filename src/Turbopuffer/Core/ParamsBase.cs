...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("TURBOPUFFER_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(TurbopufferClient).Name}/C# {GetPackageVersion()}";

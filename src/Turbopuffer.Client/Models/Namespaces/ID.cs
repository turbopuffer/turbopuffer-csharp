...
public record class ID : ModelBase
{
    ...
    public ID(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ID(long value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public void Switch(Action<string> @string, Action<long> @long)
    {
        switch (this.Value)
        {
            ...
            case long value:
                ...
                break;
            default:
                throw new TurbopufferInvalidDataException("Data did not match any variant of ID");
        }
    }
    ...
    public T Match<T>(Func<string, T> @string, Func<long, T> @long)
    {
        return this.Value switch
        {
            ...
            _ => throw new TurbopufferInvalidDataException("Data did not match any variant of ID"),
        };
    }

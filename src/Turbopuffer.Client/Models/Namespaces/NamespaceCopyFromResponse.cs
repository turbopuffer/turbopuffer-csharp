...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<NamespaceCopyFromResponse, NamespaceCopyFromResponseFromRaw>)
)]
public sealed record class NamespaceCopyFromResponse : JsonModel
{
    /// <summary>
    ...
    public NamespaceCopyFromResponse()
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public NamespaceCopyFromResponse(NamespaceCopyFromResponse namespaceCopyFromResponse)
        : base(namespaceCopyFromResponse) { }
#pragma warning restore CS8618

    public NamespaceCopyFromResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    NamespaceCopyFromResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="NamespaceCopyFromResponseFromRaw.FromRawUnchecked"/>
    public static NamespaceCopyFromResponse FromRawUnchecked(
...
class NamespaceCopyFromResponseFromRaw : IFromRawJson<NamespaceCopyFromResponse>
{
    /// <inheritdoc/>
    public NamespaceCopyFromResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => NamespaceCopyFromResponse.FromRawUnchecked(rawData);
}

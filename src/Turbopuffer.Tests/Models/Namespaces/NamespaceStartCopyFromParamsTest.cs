...
public class NamespaceStartCopyFromParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new NamespaceStartCopyFromParams
        {
            Namespace = "namespace",
    ...
    {
        NamespaceStartCopyFromParams parameters = new()
        {
            Namespace = "namespace",
            SourceNamespace = "source_namespace",
        };
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://gcp-us-central1.turbopuffer.com/v2/namespaces/namespace/async?stainless_overload=startCopyFrom"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        NamespaceStartCopyFromParams copied = new(parameters);
